...
public class ScheduledTask {
    ...
    public void minTask() {
        ...
        try {
            ...
            // 网卡信息
            List<NetAdapterState> netAdapterStateList = SigarUtil.ethernet(t);
            ...
            if (systemInfo != null) {
                if (memState != null) {
                    systemInfo.setVersionDetail(
                            systemInfo.getVersion() + "，总内存：" + FormatUtil.mToG(memState.getTotal() + "M") + "G");
            ...
            if (null != netAdapterStateList) {
                jsonObject.put("netAdapterStateList", netAdapterStateList);
            }
            //进程信息
