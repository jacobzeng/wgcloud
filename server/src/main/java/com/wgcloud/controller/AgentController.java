...
public class AgentController {
    ...
    public JSONObject minTask(@RequestBody String paramBean) {
        ...
        JSONArray netAdapterStateList = agentJsonObject.getJSONArray("netAdapterStateList");
        ...
        try {
            ...
            if (netAdapterStateList != null) {
                for (Object jsonObjects : netAdapterStateList) {
                    NetAdapterState bean = new NetAdapterState();
                    BeanUtil.copyProperties(jsonObjects, bean);
                    BatchData.NET_ADAPTER_STATE_LIST.add(bean);
                }
            }
