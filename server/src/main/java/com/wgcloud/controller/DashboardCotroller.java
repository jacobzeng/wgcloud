...
public class DashboardCotroller {
    ...
    public String systemInfoList(SystemInfo systemInfo, Model model, HttpServletRequest request) {
        Map<String, Object> params = new HashMap<String, Object>();
        try {
            PageInfo pageInfo = systemInfoService
                    .selectByParams(params, systemInfo.getPage(), systemInfo.getPageSize());
    ...
    public String hostDetail(Model model, HttpServletRequest request) {
        ...
        try {
            ...
            List<NetAdapterState> netAdapterStateList = netAdapterStateService.selectAllByParams(params);
            model.addAttribute("netAdapterStateList", netAdapterStateList);
        } catch (Exception e) {
