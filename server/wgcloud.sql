...
DROP TABLE IF EXISTS `NET_ADAPTER_STATE`;
CREATE TABLE `NET_ADAPTER_STATE` (
  `ID` char(32) NOT NULL,
  `HOST_NAME` char(30) DEFAULT NULL,
  `NAME` char(50) DEFAULT NULL,
  `IPV4_ADDRESS` char(30) DEFAULT NULL,
  `IPV4_NETMASK` char(30) DEFAULT NULL,
  `CREATE_TIME` timestamp NULL DEFAULT NULL,
  PRIMARY KEY (`ID`),
  KEY `NET_ADAPTER_ACC_HOST_INDEX` (`HOST_NAME`,`CREATE_TIME`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;